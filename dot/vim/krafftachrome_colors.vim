" krafftachrome.vim - Vim color scheme for 16-color terminals
" --------------------------------------------------------------
" Author:   Peter Fonseca (https://www.peternfonseca.com)
" Version:  0.1.0
" --------------------------------------------------------------
" modified from noctu.vim (https://github.com/noahfrederick/vim-noctu)
" --------------------------------------------------------------
...
let g:colors_name = "krafftachrome"

" krafftachrome_color = ansi_code
" obsidian is default bg, not sure how to use but i think can access with cterm=reverse
" flame_resistant_silver = default fg (use ctermfg=None)
" hot_obsidian_purple = 0
" dark_stone_gray = 8
" lava_red = 1
" lava_bright_red = 9
" treeline_green = 2
...
" lava_orange = 3
" lava_yellow = 11
" maurices_jacket_blue = 4
" katias_jacket_blue = 12
" lava_purple = 5
" lava_pink = 13
" acid_lake_deep = 6
" acid_lake_shallow = 14
" mid_ash_gray = 7
" ligh_ash_gray = 15
